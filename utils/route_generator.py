...
AVAILABLE_MODULES_INFO = {
    ...
    bullas_purchase_tools_for_moola     : (bullas_purchase_tools_for_moola, 3, 'Bullas Purchase Tools for Moola', 0, [0]),
    bullas_upgrade_tools_for_moola      : (bullas_upgrade_tools_for_moola, 3, 'Bullas Upgrade Tools for Moola', 0, [0]),
